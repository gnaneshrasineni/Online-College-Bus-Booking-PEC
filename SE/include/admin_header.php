...
<div class="row">	
	...
	<h2 style=" margin-top: 3%;"><span class="badge-primary"><?php echo $user['name']; ?></span></h2>	
		<div class="btn-group-vertical">
			<a class="btn btn-light" href="admin.php">Bus Details</a>
  			<a class="btn btn-success" href="student.php">View by Students</a>
			<a class="btn btn-info" href="">View by Department</a>
			<a class="btn btn-warning" href="">old Records</a>
		</div>		
	</div>
	<div class="col-sm-9">
